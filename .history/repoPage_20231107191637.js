const cards = [
  ...
  },
  {
    ...
    description: "'aptain CyberSails steers the Silicon Scallywag, a digital ship with a virtual reality deck where he develops "The Sea of Codes," a virtual oceanic world where coders can navigate through complex algorithms and engage in hackathons as if they were epic sea battles.'",
    keys: 'netlify',
    language: 'javascript',
    favorite:'yes',
    forks: 12,
