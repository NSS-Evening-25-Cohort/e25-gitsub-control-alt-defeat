  ...
  array.forEach((card) => {
    domString += `<div class="card" style="width: 18rem;">
      <div class="card-body">
        ...
        <p class="language"><img src="https://png.pngtree.com/png-clipart/20201029/ourmid/pngtree-circle-clipart-yellow-circle-png-image_2381940.jpgs" alt="Language" /> ${card.language}</p>
