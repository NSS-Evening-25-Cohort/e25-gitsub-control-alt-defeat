const cards = [
  ...
  },
  {
    ...
    description: '"TreasureMapDecoder" - Captain Cipherbeard is the scourge of encrypted seas, leading the charge on a repository that's all about decoding ancient pirate ciphers. His project uses a combination of classic cryptanalysis and modern machine learning to unearth the secrets hidden within tattered treasure maps. Fellow buccaneers flock to his repo to contribute to the ever-growing list of solved mysteries, each hoping to uncover the X that marks the spot.',
    keys: 'netlify',
    language: 'javascript',
    favorite:'yes',
    forks: 12,
