...
const renderRepo = (array) => {
  ...
  array.forEach((card) => {
    domString += `<div class="card" style="width: 18rem;">
      ...
      <button type="button" class="btn btn-primary" ></button>img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Star_Outline.svg/2144px-Star_Outline.svg.png" alt="favorite">Star</button>
    </div>`;
  });
