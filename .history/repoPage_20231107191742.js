const cards = [
  ...
  {
    id: 1,
    name: 'Captain Cipherbeard',
    description: '"TreasureMapDecoder" - Captain Cipherbeard is the scourge of encrypted seas, leading the charge on a repository thats all about decoding ancient pirate ciphers. His project uses a combination of classic cryptanalysis and modern machine learning to unearth the secrets hidden within tattered treasure maps. Fellow buccaneers flock to his repo to contribute to the ever-growing list of solved mysteries, each hoping to uncover the X that marks the spot.',
    keys: 'netlify',
    language: 'javascript',
    favorite:'yes',
    forks: 12,
  ...
  {
    id: 2,
    name: 'Black-Flag Bytes',
    description: 'PlunderPartition" - Black-Flag Bytes is renowned across digital oceans for their repository, which is dedicated to partitioning and managing loot (data) distribution across various cloud services. Their codebase is a masterful array of scripts and APIs designed to efficiently allocate resources, ensuring not a single byte of booty is wasted. This repository is the holy grail for pirates looking to optimize their digital hoarding and data raids.',
    keys: 'netlify',
    language: 'javascript',
    favorite:'yes',
    forks: 12,
  ...
  {
    id: 2,
    name: 'ScurvyScripter Skully',
    description: "'DavyJonesLocker' - ScurvyScripter Skully's domain is a repository filled with code that's said to send shivers down the spines of even the most hardened sea dogs. The 'DavyJonesLocker' is an archival system, albeit with a pirate twist: it uses blockchain technology to create an immutable, decentralized ledger of piratical exploits. Each commit tells a tale of adventure, ensuring that the legends of the seven seas will live on forever in the annals of the internet.",
    keys: 'netlify',
    language: 'javascript',
    favorite:'yes',
    forks: 12,
  ...
  {
    id: 2,
    name: 'RumRunner Router',
    description: "'CorsairConnect' - RumRunner Router is the digital era's answer to age-old pirate communication challenges, and their repository is the key to a secure, private messaging system on the high seas of the internet. "CorsairConnect" is an end-to-end encrypted network that facilitates anonymous parleys amongst pirates without fear of eavesdropping by navy blue-coats or rival buccaneers. This repository is a bastion for freedom of speech, allowing for the free exchange of maps, plans, and gossip across the encrypted waves.",
    keys: 'netlify',
    language: 'javascript',
    favorite:'yes',
    forks: 12,
