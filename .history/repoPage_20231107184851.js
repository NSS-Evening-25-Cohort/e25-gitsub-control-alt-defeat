  ...
  array.forEach((card) => {
    domString += `<div class="card" style="width: 18rem;">
      <div class="card-body">
        ...
        <p class="language"><img src="https://img.freepik.com/free-photo/top-view-yellow-circle-white-background_23-2148209983.jpg?size=338&ext=jpg&ga=GA1.1.1880011253.1699315200&semt=ais" alt="Language" /> ${card.language}</p>
        <p class="favorite">Favorite:${card.favorite}</p>
        <p class="forks">Forks:${card.forks}</p>
        <p class="issues">Issues:${card.issues}</p>
        <p class="updates">Updates:${card.updates}</p>
      </div>
    </div>`;
  });
